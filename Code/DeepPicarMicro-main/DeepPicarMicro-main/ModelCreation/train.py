...
for i in range(0,10):
    vid_files = glob.glob(os.path.join(os.path.dirname(__file__), "../../../../Dataset-leftonly/{}/epoch{}/*.avi".format(params.dataset, i)))
    if not vid_files:
        raise FileNotFoundError(f"No .avi files found in ../../../../Dataset-leftonly/{params.dataset}/epoch{i}/")
    ...
    while(ret):
        ...
        imgs.append(img)
        ret,img = vid.read()
    print("Checking epoch:", i, "../../../../Dataset-leftonly/{}/epoch{}/".format(params.dataset, i))
    print(glob.glob(os.path.join(os.path.dirname(__file__), "../../../../Dataset-leftonly/{}/epoch{}/*.avi".format(params.dataset, i))))
    csv_files = glob.glob(os.path.join(os.path.dirname(__file__), "../../../../Dataset-leftonly/{}/epoch{}/*.csv".format(params.dataset, i)))
    if not csv_files:
        raise FileNotFoundError(f"No .csv files found in ../../../../Dataset-leftonly/{params.dataset}/epoch{i}/")
